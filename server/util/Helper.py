...
class Helper():
    ...
    def getIndexOfMax(npArr):
        ...
        return [np.argmax(i) for i in npArr]
    
    def loadModel():
        loadedModel = keras.models.load_model(os.getenv("SERVER_PATH")+"artifacts/ann_model.h5")
        return loadedModel
    
    def loadMinMaxScaler():
        loadMinMaxScaler = load(open(os.getenv("SERVER_PATH")+"artifacts/minmax_scaler.pkl", 'rb'))
        return loadMinMaxScaler
    ...
    def getNextTimestamp(timestamp):
...
if __name__ == '__main__':
  ...
  "system_network_out_packets": [
    ...
    dateObj = Helper.convertStrToDatetime("2018-01-06 18:54:00")
    print(dateObj)